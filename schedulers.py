...
class FlowMatchEulerDiscreteScheduler(SchedulerMixin, ConfigMixin):
    ...
    def __init__(
        ...
        # FIX: Use torch.tensor instead of torch.from_numpy to avoid numpy type mismatch
...
class ConsistencyFlowMatchEulerDiscreteScheduler(SchedulerMixin, ConfigMixin):
    ...
    def __init__(
        ...
        # FIX: Use torch.tensor instead of torch.from_numpy to avoid numpy type mismatch
        self.sigmas = torch.tensor(self.sigmas.copy(), dtype=torch.float32)
    ...
    def set_timesteps(
        ...
        # FIX: Use torch.tensor instead of torch.from_numpy to avoid numpy type mismatch
        inference_indices = torch.tensor(inference_indices, dtype=torch.long)
